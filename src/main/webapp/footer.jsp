...
<div class="footer ">
    <div class="grid wide">
        <div class="row">
            ...
            <div class="col">
                <h3 class="footer__heading">Vào trên ứng dụng</h3>
                <div class="footer__download">
                    <img src="../css/img/qrcode.png" alt="Download qr" class="footer__download-qr">
                </div>
            </div>
        </div>
        <div class="footer-bottom">
            <p class="footer__text">© 2024 - Bản quyền thuộc về Công ty TNHH 3 thành viên</p>
        </div>
    </div>
</div>
<script>
